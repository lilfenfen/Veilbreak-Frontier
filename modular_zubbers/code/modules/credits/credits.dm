...
/proc/generate_titles()
	...
	if(!GLOB.end_credits_title)
		...
		possible_titles += "THE [pick("DOWNFALL OF ", "RISE OF ", "TROUBLE WITH ", "FINAL STAND OF ", "DARK SIDE OF ", "DESOLATION OF ", "DESTRUCTION OF ", "CRISIS OF ")]\
							...
							"THE SUPERMATTER CRYSTAL", "MEDICAL", "ENGINEERING", "SECURITY", "RESEARCH", "THE SERVICE DEPARTMENT", "COMMAND", "THE EXPLORERS", "THE CLOWNS", "CARGO",\
							"VENUS STATION")]" //VENUS EDIT: BUBBER STATION -> VENUS STATION, KEPT "THE EXPLORERS"
