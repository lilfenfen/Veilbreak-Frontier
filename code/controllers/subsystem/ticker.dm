...
SUBSYSTEM_DEF(ticker)
	...
	var/station_time_rate_multiplier = 8 //factor of station time progressal vs real time. // BUBBER EDIT CHANGE - SERVER TIME OFFSET - ORIGINAL: 12 //VENUS EDIT - Original: 2 (Bubber's change)
